					...
					<div className="row">
						...
						<div className="col-lg-6">
							<div className="mi-about-content">
								...
								<p>
									Je suis un développeur Front-End Javascript. Je crée des sites et applications web
									responsive. Je sais également créer des applications mobiles mutltiplateformes
					...
					<div className="mi-service-wrapper">
						<div className="row mt-30-reverse">
							{services.map((service) => (
								<div className="col-lg-6 col-md-6 col-12 mt-3" key={service.title}>
